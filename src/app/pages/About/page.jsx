      ...
      <div>
          ...
          <div class="pt-16 pb-80 sm:pt-24 sm:pb-40 lg:pt-32 lg:pb-48">
            <div class="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
              <div class="sm:max-w-lg">
                <h1 class="font text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
              <div className="mx-8">
                ...
                <p className="mt-4 text-gray-600 text-lg">
                  Welcome to Travel Blog! We are avid travelers with a passion
                  for exploring the world and sharing our adventures. Our
                  journey began in 2024, when we decided to turn our wanderlust
                  into a way of life and document every step along the way. We
                  believe that travel is not just about ticking off places from
                  a bucket list, but about immersing ourselves in diverse
                  cultures, making meaningful connections, and creating
                ...
                {isReadMore && (
                  <div>
                    <p className="mt-4 text-gray-600 text-lg">
                      ...
                      unique charm and stories. Our blog is a culmination of
                      years of adventure, learning, and a desire to inspire
                      others to explore the globe.
                    </p>
                  </div>
                )}
                <button
        ...
        <section>
          ...
          <p className="my-16 pl-8 md:pl-8 py-4 mx-4 md:mx-10">
            ...
            the unexpected! Stepping off a plane, I’m always in a hurry to get
            my passport stamped, reclaim my luggage and walk out of the arrivals
            hall ready to begin a new adventure. <br />I love the planning, the
            anticipation, the journey, be it by plane, train, bus or boat and of
            course, the actual holiday and finally all the wonderful memories
            and experiences I bring home that live with me forever. That was the
            original reason why I created this blog so that I could have an
            online diary of my recent trips to look back on in the future. I’ve
            been surprised but thrilled that so many of you have taken an
            interest in my travels and enjoy reading about my trips – it’s very
            encouraging and makes me very happy! From starting as a hobby my
            blog has evolved into an award winning online travel resource
            providing inspiration to fellow travellers.
          </p>
          {/* My Journey */}
          <div className="relative h-screen w-full">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4 md:px-0">
              ...
              <p className="text-xl text-white mt-4 max-w-lg">
                Welcome to my corner of the internet! My journey into the world
                of vlogging began in 2024, driven by an insatiable curiosity and
                a desire to capture the essence of the places I visit and the
                people I meet. Traveling has always been about more than just
                the destination for me. It about the thrill of the unknown, the
                joy of discovery, and the connections made along the way. On
                this site, you&apos;ll find a diverse collection of vlogs that
                capture the beauty and diversity of our world.
              </p>
            </div>
          </div>
        </section>
        ...
        <Transition>
          <section className="loved_places my-20">
            ...
            <div className="bg-pink-600 w-20 h-1 mx-auto my-4 rounded-xl"></div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 p-4 place-items-center mx-10">
              <Image
                src={"/images/photo1.jpg"}
                width={400}
                height={400}
                className="hover:opacity-75 rounded-xl"
                alt="photo1"
              ></Image>
              <Image
                src={"/images/photo2.jpg"}
